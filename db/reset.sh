...
for f in db/00_schema.sql db/01_seed.sql db/02_roles.sql db/03_observability.sql db/04_app.sql db/05_phone_identity.sql db/06_password_reset.sql db/07_remove_auth.sql; do
    echo "==> applying $f"
